  ...
  return (
    <>
      ...
      <div className="relative flex items-center justify-center py-8 bg-[#F0F4F8]">
        <div
          data-aos="fade-up"
          className="w-[90%] md:w-[80%] lg:w-[70%] rounded-3xl overflow-hidden shadow-lg -mt-20 border-8 border-[#021E73]"
        >
          <img
            src={banner1}
            alt="Banner"
            className="w-full h-auto object-cover  "
            style={{ color: "blue", borderRadius: "24px 24px 0px 0px" }}
          />
        </div>
      </div>
      ...
      <div className="text-center py-12 bg-[#F0F4F8]">
        ...
        <div
          className="flex flex-wrap justify-evenly items-center gap-6 bg-[#021345] text-2xl lg:text-3xl text-yellow-50 py-6 mt-22 font-bold h-[20vh]"
          data-aos="fade-up"
        >
      ...
      <div className="mt-14 mb-14 overflow-hidden">
        ...
        {/* Feature Sections */}
        <div
          className="flex flex-col md:flex-row items-center justify-center gap-10 px-6 mt-12"
          data-aos="fade-up"
        >
          ...
          >
            <h1 className="text-3xl font-bold my-4">
              Streamlined Book Registration Process
            </h1>
            <p className="text-xl my-4">
              Register books efficiently with our user-friendly system for
              better tracking.
            </p>
        ...
        <div
          className="flex flex-col md:flex-row-reverse items-center justify-center gap-10 mt-20 px-6"
          data-aos="fade-up"
        >
          {/* Image with side animation */}
          <img
          ...
          >
            <h1 className="text-3xl font-bold my-4">
              Admin Panel for Comprehensive Oversight
            </h1>
            <p className="text-xl my-4">
              Take charge of your library operations with our powerful admin
              panel.
            </p>
            <button className="bg-[#578BF2] text-white px-6 py-3 rounded-full hover:bg-[#91B2F2] transition duration-300 font-bold">
              Admin Panel
      ...
      <div className="bg-gradient-to-b from-[#031037] to-[#021E73] py-20 section5">
        <div className="text-center text-white max-w-3xl mx-auto px-4">
          ...
          <p
            className="text-2xl mt-6 opacity-90"
            data-aos="fade-up"
            data-aos-delay="200"
          >
            Keep track of all your library books and their availability in
            real-time.
          </p>
        </div>
          ...
          {[
            {
              img: banner4,
              title: "Book Overview",
              desc: "Track Books Effectively",
            },
            {
              img: banner5,
              title: "Inventory Management",
              desc: "Manage your library inventory",
            },
            {
              img: banner6,
              title: "Library Management System",
              desc: "Efficient Book Tracking",
            },
          ].map((item, index) => (
            <div
              key={index}
              className="relative group bg-white shadow-lg rounded-3xl overflow-hidden w-[22rem] transition-transform duration-300 transform hover:scale-105 hover:shadow-2xl"
              data-aos="fade-up"
            ...
            >
              ...
              <div className="p-6 text-center text-gray-900">
                <h3 className="text-2xl font-bold mb-2 group-hover:text-[#578BF2] transition-colors duration-300">
                  {item.title}
                </h3>
      ...
      <div className="section6 bg-gradient-to-b from-[#021E73] to-[#031037] py-20">
        <div
          className="flex flex-col md:flex-row items-center justify-center gap-10 px-6 mt-12 max-w-6xl mx-auto"
          data-aos="fade-up"
        >
          <div className="w-full md:w-[45%] text-center md:text-left">
            ...
            <p className="text-lg text-white mb-6 opacity-80">
              Fill out the form below to register and gain access to our library
              services.
            </p>
      ...
      <div className="section8 py-20 bg-[#F1F5F9]">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-black mt-4 max-w-2xl mx-auto">
            Amazing platform for managing our library effectively and
            efficiently!
          </p>
        </div>
          ...
          {[
            {
              name: "Ritam",
              testimonial:
                "We were amazed by how quickly it improved our book tracking and management processes!",
              imgSrc:
                "https://res.cloudinary.com/dbyioi2qq/q_auto/v1673162481/static/yoel-j-gonzalez-xi0saahoc-k-unsplashjpg_1673161595_41636.jpg", // Replace with the actual image path
              rating: 5,
            },
            {
              name: "Shashank",
              testimonial:
                "I Feel The Library Of This WebsiteQuite Good, Also The UI Design Is Very User Friendly",
              imgSrc:
                "https://res.cloudinary.com/dbyioi2qq/q_auto/v1673162507/static/prince-akachi-l3ihxodmyhq-unsplashjpg_1673161595_55568.jpg", // Replace with the actual image path
              rating: 4,
            },
            {
              name: "Shahna shsha",
              testimonial:
                "This library management system is a game-changer for us, making everything much more organized.",
              imgSrc:
                "https://res.cloudinary.com/dmuecdqxy/q_auto/v1729839740/static/img_20241025_122233jpg_1729839735_29363.jpg", // Replace with the actual image path
              rating: 5,
            },
            ...
            >
              ...
              <p className="text-lg text-black italic mt-4 animate__animated animate__fadeIn animate__delay-3s">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center justify-center gap-10 mt-10">
          ...
          >
            <h1 className="text-4xl font-bold my-4 text-white">
              Connect with Our Library Management System Team Today
            </h1>
            <p className="text-xl my-4 text-amber-50">
              Take charge of your library operations with our powerful admin
              panel.
            </p>
      ...
      <footer className="bg-[#021E73] text-white py-12 px-6 mt-22">
        <div className="max-w-7xl mx-auto text-center md:text-left">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <p className="text-lg opacity-80">
                We provide an efficient and user-friendly library management
                system that helps streamline book tracking, inventory
            ...
            <div>
              ...
              <ul>
                <li>
                  <a
                    href="#home"
                    className="text-lg text-white hover:text-amber-50"
                  >
                    Home
                  </a>
                </li>
          ...
          {/* Bottom Section */}
          <div className="mt-12 border-t border-amber-50 pt-6 flex justify-between">
            <p className="text-lg text-amber-50 opacity-80">
